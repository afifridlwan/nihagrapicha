                          ...
                          <div class="card-body">
                              <form method="post" action="{{ route('produk.store')}}" enctype="multipart/form-data"> 
                                  ...
                                  <div class="form-group">
                                    ...
                                    <textarea name="deskripsi" id="deskripsi" class="form-control" rows="3"  placeholder="Deskripsi Produk" required></textarea>
                                </div>
                                ...
                                <div class="mb-8">
                                    ...
                                    <input type="text" class="form-control" id="stok" aria-describedby="stok" name="stok" required>
                                    <small class="text-danger d-none" id="name-warning">Please fill in the name.</small>
                                </div>
                                <br>
